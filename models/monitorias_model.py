class monitorias:
    ...
    def todic(self):
        # Mantén los nombres originales para consistencia
        return {
            "kar_id": self.kar_id,
            "kar_pro_id_fk": self.kar_pro_id_fk,  
            "kar_lot_id_fk": self.kar_lot_id_fk,  
            "kar_inm_id_fk": self.kar_inm_id_fk,  
            "kar_fecha": self.kar_fecha,  
            "kar_tipo": self.kar_tipo,  
            "kar_cantidad": self.kar_cantidad,  
            "kar_saldo_anterior": self.kar_saldo_anterior,  
            "kar_saldo_actual": self.kar_saldo_actual,  
            "kar_costo_unitario": self.kar_costo_unitario,  
            "kar_costo_total": self.kar_costo_total
        }
